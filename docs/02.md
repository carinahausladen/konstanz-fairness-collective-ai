...
> 📓 **Lab notebooks** — [bias metrics & datasets](../notebooks/02_bias_metrics/): [WEAT](../notebooks/02_bias_metrics/1_metrics_WEAT.ipynb) · [masked-token](../notebooks/02_bias_metrics/2_metrics_maskedtoken.ipynb) · [pseudo-log-likelihood](../notebooks/02_bias_metrics/3_metrics_pll.ipynb) · [generated-text](../notebooks/02_bias_metrics/4_metrics_generatedtext.ipynb) · [datasets](../notebooks/02_bias_metrics/5_datasets.ipynb)
...
|---|---|---|---|
| Vector space | **Embedding-based** | Model's hidden representations | [`1_metrics_WEAT.ipynb`](https://github.com/carinahausladen/konstanz-fairness-collective-ai/blob/main/notebooks/02_bias_metrics/1_metrics_WEAT.ipynb) |
| Conditional probability | **Probability-based** | Token log-probabilities | [`2_metrics_maskedtoken.ipynb`](https://github.com/carinahausladen/konstanz-fairness-collective-ai/blob/main/notebooks/02_bias_metrics/2_metrics_maskedtoken.ipynb) · [`3_metrics_pll.ipynb`](https://github.com/carinahausladen/konstanz-fairness-collective-ai/blob/main/notebooks/02_bias_metrics/3_metrics_pll.ipynb) |
| Output text | **Generated text-based** | Only the generated continuations | [`4_metrics_generatedtext.ipynb`](https://github.com/carinahausladen/konstanz-fairness-collective-ai/blob/main/notebooks/02_bias_metrics/4_metrics_generatedtext.ipynb) |
