...
- [The Tech Jobs Bust Is Real. Don't Blame AI (Yet) (2026)](https://www.economist.com/finance-and-economics/2026/04/13/the-tech-jobs-bust-is-real-dont-blame-ai-yet) — *The Economist*, Finance & economics, 13 April 2026.
  *Counter-narrative to the Angelo/Fortune framing. US tech-employment share fell from 2.5% (late 2022) to 2.3%, with >500k tech jobs "missing" vs trend — but AI is probably not yet the cause. SF-area AI adoption is still ~25%, US adoption much lower; a Bank of England survey (Yotzov et al.) finds "essentially zero" AI impact on employment over three years. The timing fits a more familiar story: COVID-era hiring binge, 2022 rate hikes slowing IT investment, and outsourcing — US imports of cloud/data-storage services more than doubled 2021–24. Meanwhile tech occupations grew in retail (+12%), property (+75%) and construction (+100%) 2022–25. "Tech jobs aren't going away. They are spreading through the economy." Pairs with Angelo/Fortune to show how the same labor-market data can be framed as crisis or as cyclical-plus-diffusion.*
